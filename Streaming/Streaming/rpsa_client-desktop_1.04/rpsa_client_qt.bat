...
@echo off
SET BASE_DIR=%~dp0
SET PATH=%BASE_DIR%/bin/;%BASE_DIR%/lib/;%PATH%;/lib/systemLibs
SET CQT_PKG_ROOT=%BASE_DIR%
SET CQT_RUN_FILE=%BASE_DIR%rpsa_client_qt.bat



start "rpsa_client_qt" /B "%BASE_DIR%/bin/rpsa_client_qt.exe" %*
